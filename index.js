...
// }
// make_shirt("L")
function make_shirt(size = "S", message = "I Love Coding") {
    console.log(`We have confirmed your shirt order for "${size}" size, which will have "${message}" printed on front side.`);
}
make_shirt();
//Q.38
...
//Q.44
function make_your_sandwich(ingredients) {
    let order = "You want";
...
function carInfo(manufacturer, modelName, ...args) {
    let car = {
...
let createCar = carInfo('Toyota', 'Camry', 'color', 'Blue', 'year', 2023, 'automatic', true);
